<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/当前版本-v1.1.27-0ea5e9" alt="当前版本 v1.1.27" />
...
v1.1.27 增加 Team 子号创建工作流：复用现有 OAuth 接码页面的领取、换号、取消、验证码轮询、计费和站内二次确认；支持管理员在可见服务器浏览器中完成登录和授权，并提供成员查看、邀请、角色调整与移除。安装和在线更新均先启动并验证 XIASS 主服务，再延迟处理 Chromium 与 Team 自动化组件；附属组件失败不会阻断主服务，更新器保留备份和回滚路径。
