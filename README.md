<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/当前版本-v1.0.102-0ea5e9" alt="当前版本 v1.0.102" />
...
v1.0.102 新增独立会员接码工作台，并保留原 OAuth 授权流程与 iOS 管理端接码 UI；接码会话复用 XIASS 用户余额和支付回调，支持管理员调整后续会话价格、会员一分钟换号/取消保护、国旗地区显示、服务端加密卡密队列与价格快照结算。保留 XIASS 品牌、深浅主题、模型价格、批量导入、FRP/软路由/SOCKS、在线更新、配置助手及全部持久化数据路径。
