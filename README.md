<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/当前版本-v1.1.28-0ea5e9" alt="当前版本 v1.1.28" />
...
v1.1.28 修正 host updater 镜像的构建上下文路径，并增加发布契约检查，确保更新器入口脚本在多架构镜像构建中始终被正确复制。上一版新增的 Team 子号创建工作流、OAuth 接码复用、服务器浏览器、成员管理和两阶段启动更新能力继续保留。
