...
TEAM_CHILD_BROWSER_CONTROL_TTL_SECONDS="${TEAM_CHILD_BROWSER_CONTROL_TTL_SECONDS:-120}"
...
validate_configuration() {
    ...
    [[ "$TEAM_CHILD_BROWSER_CONTROL_TTL_SECONDS" =~ ^[0-9]+$ ]] || die "TEAM_CHILD_BROWSER_CONTROL_TTL_SECONDS 必须是整数。"
    [ "$TEAM_CHILD_BROWSER_CONTROL_TTL_SECONDS" -ge 30 ] && [ "$TEAM_CHILD_BROWSER_CONTROL_TTL_SECONDS" -le 600 ] || die "TEAM_CHILD_BROWSER_CONTROL_TTL_SECONDS 必须介于 30 至 600 秒。"
}
...
TEAM_CHILD_BROWSER_CONTROL_TTL_SECONDS=${TEAM_CHILD_BROWSER_CONTROL_TTL_SECONDS}
