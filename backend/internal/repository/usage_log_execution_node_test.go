...
func TestExecutionNodeUsagePredicateKeepsDeletedAccountHistory(t *testing.T) {
	conditions, args := appendExecutionNodeUsageLogWhereCondition(
		[]string{"user_id = $1"}, []any{int64(7)}, "api.xiass.com", "api.xiass.com", "ul.account_id",
	)
	require.Equal(t, []any{int64(7), "api.xiass.com", "api.xiass.com"}, args)
...
func TestExecutionNodeUsagePredicateDoesNotFilterAllOwners(t *testing.T) {
	conditions, args := appendExecutionNodeUsageLogWhereCondition(nil, nil, "", "api.xiass.com", "account_id")
