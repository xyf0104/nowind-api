...
func TestForwardGrokChatViaResponsesTraeCompatibilityFieldsKeepCacheRoute(t *testing.T) {
	...
	// xAI's ModelInput accepts historical assistant text as a string. The
	// sanitizer may collapse the OpenAI output_text array, but it must retain
	// the Trae reasoning envelope exactly.
