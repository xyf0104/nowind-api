...
// payload. Some Gemini-compatible streams resend cumulative content, so
// summing every chunk would bill the same image more than once.
...
// countGeminiInlineImageOutputs accepts both Gemini REST camelCase fields and
// snake_case fields returned by some SDKs and compatible upstream services.
