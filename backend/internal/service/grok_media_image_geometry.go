...
func grokImagineImageResolutionFromSize(size string) string {
	...
	// xAI Imagine accepts only 1k/2k and uses geometry semantics that are
	// independent from XIASS's OpenAI billing tiers. In particular, OpenAI
	// 1536x1024 is billed as 1K, while the same long edge must be sent to
	// Imagine as 2k.
