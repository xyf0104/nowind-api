...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	adminUserGroupAccountAllowlistService := service.NewAdminUserGroupAccountAllowlistService(adminService, userGroupAccountAllowlistService, userGroupAccountAllowlistCandidateRepository, userGroupAccountRuntimeReader)
	groupHandler := handler.ProvideAdminGroupHandler(adminService, dashboardService, groupCapacityService, adminUserGroupAccountAllowlistService)
	...
	runtimeExportService := service.NewRuntimeExportService()
	backupHandler := admin.NewBackupHandler(backupService, userService, imageStorageSettingService, runtimeExportService)
	oAuthHandler := admin.NewOAuthHandler(oAuthService)
	openAIOAuthHandler := handler.ProvideOpenAIOAuthHandler(openAIOAuthService, adminService, openAIQuotaService, rateLimitService, redisClient, secretEncryptor)
	...
	settingHandler := handler.ProvideAdminSettingHandler(settingService, emailService, turnstileService, aliyunCaptchaService, opsService, paymentConfigService, paymentService, userAttributeService, notificationEmailService, totpService, userService, pixlabSMSService)
	...
	batchImagePublicService := service.NewBatchImagePublicService(batchImageRepository, accountRepository, accountCandidateAccessPolicy, groupRepository, userGroupRateRepository, batchImageQueue, batchImageModelPricingResolver, usageBillingRepository, apiKeyAuthCacheInvalidator, configConfig)
